...
Config.From             = 100     -- Starting progress percentage
Config.To               = 0   -- Ending progress percentage
...
Config.Radius       = 45        -- Radius of the radial dial
Config.Stroke       = 7        -- stroke width of the radial dial
Config.Width        = 200       -- Width of the linear bar
Config.Height       = 30        -- Height of the linear bar
Config.Cap          = 'round'    -- or 'round'
