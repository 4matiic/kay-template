            ...
            Citizen.CreateThread(function()
                if Animation.scenario ~= nil then
                    ...
                    if Animation.animationDictionary ~= nil and Animation.animationName ~= nil then
                        ...
                        TaskPlayAnim(player, Animation.animationDictionary, Animation.animationName, 3.0, 1.0, -1,
                            Animation.flag, 0, 0, 0, 0)
                    end
                end
            end)
        end
...
RegisterCommand("rprogress", function(source, args, rawCommand)
    exports.rprogress:Start('', 1000)
