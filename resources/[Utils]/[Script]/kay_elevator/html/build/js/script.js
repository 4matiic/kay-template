...
function createFloorButtons(elevatorId, floors) {
    ...
    floors.forEach(floor => {
        ...
        button.textContent = floor.name; // afficher le libellé personnalisé (-1, RDC, etc.)
...
// Aperçu hors-FiveM: si GetParentResourceName n'existe pas, afficher un exemple pour prévisualisation
if (typeof GetParentResourceName === 'undefined') {
    ...
    createFloorButtons('demo', demoFloors);
}
