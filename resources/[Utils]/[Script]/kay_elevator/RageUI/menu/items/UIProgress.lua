...
local SettingsButton = {
    ...
    Text = { X = 8, Y = 10, Scale = 0.33 },
    LeftBadge = { Y = 0, Width = 40, Height = 40 },
    RightBadge = { X = 385, Y = 0, Width = 40, Height = 40 },
    RightText = { X = 420, Y = 12, Scale = 0.35 },
    SelectedSprite = { Dictionary = "RageUI_", Texture = "custom_background", Y = 5, Width = 431, Height = 38 },
}

local SettingsProgress = {
    Background = { X = 8, Y = 24, Width = 415, Height = 10 },
    Bar = { X = 12, Y = 27, Width = 407, Height = 6 },
    Height = 40
}
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Selected then
                    -- Couleur Grishe opaque pour le survol
                    ...
                    ProgressHovered = RageUI.IsMouseInBounds(CurrentMenu.X + SettingsProgress.Bar.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + SettingsProgress.Bar.Y + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset - 8, SettingsProgress.Bar.Width + CurrentMenu.WidthOffset, SettingsProgress.Bar.Height + 16)
                end
