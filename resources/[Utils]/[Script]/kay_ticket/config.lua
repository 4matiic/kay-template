...
Config.ScratchCooldownInSeconds = 3 -- Cooldown in SECONDS, when will player be able to scratch another ticket?
Config.ShowCooldownNotifications = false -- Show a notification to player with the remaining cooldown timer
