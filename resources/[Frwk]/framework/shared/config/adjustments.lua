...
Config.DiscordActivity = {
    appId = 0000000, -- Discord Application ID,
    assetName = "image", --image name for the "large" icon.
    assetText = "", -- Text to display on the asset
    buttons = {
        { label = "Join Server", url = "https://discord.gg/chinaleak" },
        { label = "Discord", url = "https://discord.gg/chinaleak" },
    },
