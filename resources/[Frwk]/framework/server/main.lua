...
CreateThread(function()
    while true do
        ...
        for i = 0, GetNumResources() - 1 do
            ...
            -- états considérés "finis"
            if st ~= 'started' and st ~= 'stopped' then
                ok = false
                break
            end
        end
...
^5
            ...
            ^7[^1+^7] ^5 La base a été lancée avec succès !  
            ^7[^1+^7] ^5 Debug & clean backdoor par Kays (4matic)
            ^7[^1+^7] ^5 https://discord.gg/cykauk9jYj ^7
]])
            break
        end
    end
