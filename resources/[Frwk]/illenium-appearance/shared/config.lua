...
Config.SaveClothesAsItems = true

Config.ClothingComponents = {
    [1] = { type = 'cloth_mask', label = 'Masque' }, 
    [3] = { type = 'cloth_arms', label = 'Bras' }, 
    [4] = { type = 'cloth_pants', label = 'Pantalon' }, 
    [5] = { type = 'cloth_bags', label = 'Sac' }, 
    [6] = { type = 'cloth_shoes', label = 'Chaussures' }, 
    [7] = { type = 'cloth_chain', label = 'Chaîne' }, 
    [8] = { type = 'cloth_tshirt', label = 'T-shirt' }, 
    [9] = { type = 'cloth_bproof', label = 'Gilet' }, 
    [10] = { type = 'cloth_decals', label = 'Décoration' }, 
    [11] = { type = 'cloth_torso', label = 'Veste' }, 
}

Config.ClothingProps = {
    [0] = { type = 'cloth_helmet', label = 'Chapeau' }, 
    [1] = { type = 'cloth_glasses', label = 'Lunettes' }, 
    [2] = { type = 'cloth_ears', label = 'Oreilles' }, 
    [6] = { type = 'cloth_watches', label = 'Montre' }, 
    [7] = { type = 'cloth_bracelets', label = 'Bracelet' } 
}
